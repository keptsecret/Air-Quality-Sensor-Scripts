/* For use with IoTtweet API
 *  Status: complete (pretty much)
 *  MQ7 and MQ2 sensors have been blotted out for the time being
 */
...
//pins
const int dhtpin = 2;
const int dustpin = 16; //actually D0 on nodemcu
...
void loop() {
  ...
  /*String response = iot.WriteDashboard(userid, key, humidity, temp, heatindex, conc, private_tweet, public_tweet);
