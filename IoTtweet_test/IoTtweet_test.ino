...
const char *userid = "000498";            //IoTtweet account user ID (6 digits, included zero pre-fix)
const char *key = "bmc5w8dkpy93";     //IoTtweet registered device key in "MY IOT Garage"
const char *ssid = "Dell_pc";                    //Your-WiFi-router-SSID
const char *password = "0853348548";            //Your-WiFi-password
